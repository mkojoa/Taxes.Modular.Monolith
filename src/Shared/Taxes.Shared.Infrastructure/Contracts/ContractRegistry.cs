...
using Taxes.Shared.Abstractions.Contracts;
...
namespace Taxes.Shared.Infrastructure.Contracts;
    ...
    private void ValidateContract(Type contractType, string path = null)
    {
        ...
        var originalType = _types
            .Where(x => x.FullName is not null &&
                        x.FullName.Contains($"Taxes.Modules.{module}", StringComparison.InvariantCultureIgnoreCase))
